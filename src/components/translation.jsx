  ...
  return (
    <div>
      <h1 className="main-h1">
        Hello, Je suis Alain,{" "}
        <span className="main-highlight">Développeur Front-end Junior</span>. Je
  ...
  return (
    <div>
      <h1 className="main-h1">
        ...
        like to code for <span className="main-highlight">Web and Mobile </span>
      ...
      <h2 className="main-h2">
        ...
        or send me an Email:
        <span className="main-highlight"> contact@alain.codes</span> for future
        projects!
      </h2>
    </div>
  )
