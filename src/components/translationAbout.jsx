...
function French(props) {
  return (
    <div>
      ...
      <p className="about-p">
        Anciennement cuisinier à Paris, quand je ne code pas, vous me trouverez
        certainement entrain de regarder ou de lire des livres/vidéos de cuisine
        ou simplement derrière les fourneaux !
      </p>
    </div>
  )
}
...
function English(props) {
  return (
    <div>
      <h1 className="about-h1">About</h1>
      <p className="about-p">
        I build stuff for <span className="about-highlight">Web & Mobile</span>{" "}
        devices using <span className="about-highlight">ReactJS</span>. I work
        with a lot of appetite, honesty and commitment. I also like create nice{" "}
      ...
      <p className="about-p">
        ...
        cooking stuff or in front of the stove, I was working as a cook in Paris
        years ago !!
      </p>
    </div>
  )
